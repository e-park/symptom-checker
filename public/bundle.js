...
var View = function () {
  function View(el, template, context, binds) {
  ...
  (0, _createClass3.default)(View, [{
    ...
    value: function render() {
      ...
      return this.template(this.context).then(function (html) {
    ...
    value: function _bindEvents() {
      ...
      var _loop = function _loop(b) {
        _this2.el.querySelectorAll(b).forEach(function (item) {
          item.addEventListener(_this2.binds[b].type, _this2.binds[b].listener);
        });
      };
    ...
    value: function _unbindEvents() {
      ...
      var _loop2 = function _loop2(b) {
        _this3.el.querySelectorAll(b).forEach(function (item) {
          item.removeEventListener(_this3.binds[b].type, _this3.binds[b].listener);
        });
      };
...
var _freeze = __webpack_require__(101);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(169), __webpack_require__(170)(module)))
...
var _settings = __webpack_require__(96);
...
var _infermedicaApi = __webpack_require__(94);

var _infermedicaApi2 = _interopRequireDefault(_infermedicaApi);

var _patient = __webpack_require__(95);
...
var DemoApp = function (_App) {
  (0, _inherits3.default)(DemoApp, _App);

  function DemoApp(el) {
    (0, _classCallCheck3.default)(this, DemoApp);

    var _this = (0, _possibleConstructorReturn3.default)(this, (DemoApp.__proto__ || (0, _getPrototypeOf2.default)(DemoApp)).call(this, el, _base2.default));

    _this.api = new _infermedicaApi2.default(_settings2.default['app-id'], _settings2.default['app-key']);

    _this.patient = new _patient2.default();
  ...
  (0, _createClass3.default)(DemoApp, [{
    key: '_afterRender',
    value: function _afterRender() {
      ...
      this.nextButton.addEventListener('click', function (e) {
        return _this2.nextStep(e);
      });
    }
  }, {
    key: 'startInterview',
    value: function startInterview() {
      this.controller = new _controller2.default(this.el.querySelector('#step-container'));

      var currentView = this.views[this.currentStep];
...
var Controller = function () {
  ...
  (0, _createClass3.default)(Controller, [{
    ...
    key: "setView",
    value: function setView(name, context) {
      this._beforeSetView(name);
      var ViewClass = this.viewMapper[name];
    ...
    key: "_beforeSetView",
    value: function _beforeSetView(name) {
      // intentionally left blank
    }
  }]);
  return Controller;
...
var BasicView = function (_View) {
  (0, _inherits3.default)(BasicView, _View);

  function BasicView(el, context) {
    (0, _classCallCheck3.default)(this, BasicView);

    var handleSexChange = function handleSexChange(e) {
      _this.context.patient.setSex(e.target.value);
    };

    var handleAgeChange = function handleAgeChange(e) {
      _this.context.patient.setAge(e.target.value);
    };
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (BasicView.__proto__ || (0, _getPrototypeOf2.default)(BasicView)).call(this, el, _template2.default, context, binds));

    _this.context.patient.reset();
    return _this;
  }
...
var _taggedTemplateLiteral2 = __webpack_require__(19);
...
var _templateObject = (0, _taggedTemplateLiteral3.default)(['\n          <h5 class="card-title">Please check all that apply to you.</h5>\n          <div class="card-text">\n            <form>\n              ', '\n            </form>\n            <p class="text-muted small"><i class="fa fa-info-circle"></i> Above you see the most common risk factors. Although /diagnosis may return questions about risk factors, when implementing a symptom checker we recommend asking the patient about common risk factors before the actual interview begins. This helps to steer the interview in the right direction and to reduce its length. Please read more about risk factors <a target="_blank" href="https://developer.infermedica.com/docs/diagnosis#common-risk-factors">here</a>.</p>\n          </div>\n        '], ['\n          <h5 class="card-title">Please check all that apply to you.</h5>\n          <div class="card-text">\n            <form>\n              ', '\n            </form>\n            <p class="text-muted small"><i class="fa fa-info-circle"></i> Above you see the most common risk factors. Although /diagnosis may return questions about risk factors, when implementing a symptom checker we recommend asking the patient about common risk factors before the actual interview begins. This helps to steer the interview in the right direction and to reduce its length. Please read more about risk factors <a target="_blank" href="https://developer.infermedica.com/docs/diagnosis#common-risk-factors">here</a>.</p>\n          </div>\n        ']),
    _templateObject2 = (0, _taggedTemplateLiteral3.default)(['\n                    <div class="custom-control custom-checkbox">\n                      <input id="', '" type="checkbox" class="input-risk custom-control-input">\n                      <label for="', '" class="custom-control-label custom-checkbox mb-2 mr-sm-2 mb-sm-0">', '</label>\n                    </div>\n                  '], ['\n                    <div class="custom-control custom-checkbox">\n                      <input id="', '" type="checkbox" class="input-risk custom-control-input">\n                      <label for="', '" class="custom-control-label custom-checkbox mb-2 mr-sm-2 mb-sm-0">', '</label>\n                    </div>\n                  ']); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                * Created by Tomasz Gabrysiak @ Infermedica on 08/02/2017.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                */
...
var template = function template(context) {
  return new _promise2.default(function (resolve) {
    context.api.getRiskFactors().then(function (risks) {
      resolve((0, _helpers2.default)(_templateObject, risks.map(function (risk) {
        if (context.commonRiskFactors.indexOf(risk.id) >= 0) {
          return (0, _helpers2.default)(_templateObject2, risk.id, risk.id, risk.name);
        }
      })));
    });
  });
...
var CommonRisksView = function (_View) {
  (0, _inherits3.default)(CommonRisksView, _View);

  function CommonRisksView(el, context) {
    var _this;

    (0, _classCallCheck3.default)(this, CommonRisksView);
    ...
    var handleRisksChange = function handleRisksChange(e) {
      var group = {};
      _this.el.querySelectorAll('.input-risk').forEach(function (item) {
        group[item.id] = { reported: item.checked };
      });
      _this.context.patient.addSymptomsGroup(group);
    };
    ...
    return _this = (0, _possibleConstructorReturn3.default)(this, (CommonRisksView.__proto__ || (0, _getPrototypeOf2.default)(CommonRisksView)).call(this, el, _template2.default, context, binds));
  }

  return CommonRisksView;
}(_view2.default);

exports.default = CommonRisksView;
...
var GeoRisksView = function (_View) {
  (0, _inherits3.default)(GeoRisksView, _View);

  function GeoRisksView(el, context) {
    var _this;

    (0, _classCallCheck3.default)(this, GeoRisksView);
    ...
    return _this = (0, _possibleConstructorReturn3.default)(this, (GeoRisksView.__proto__ || (0, _getPrototypeOf2.default)(GeoRisksView)).call(this, el, _template2.default, context, binds));
  }

  return GeoRisksView;
}(_view2.default);

exports.default = GeoRisksView;
...
var template = function template(context) {
  return new _promise2.default(function (resolve) {
    resolve((0, _helpers2.default)(_templateObject));
  });
};
...
var _get2 = __webpack_require__(54);
...
var NLPView = function (_View) {
  (0, _inherits3.default)(NLPView, _View);

  function NLPView(el, context) {
    (0, _classCallCheck3.default)(this, NLPView);

    var handleFeelChange = function handleFeelChange(e) {
      _this.context.api.parse(e.target.value).then(function (response) {
        _this.updateObservations(response.mentions);
      });
    };
    ...
    var binds = {
      '#input-feel': {
        type: 'input',
        listener: _lodash2.default.debounce(handleFeelChange, 400)
      }
    };

    var _this = (0, _possibleConstructorReturn3.default)(this, (NLPView.__proto__ || (0, _getPrototypeOf2.default)(NLPView)).call(this, el, _template2.default, context, binds));

    _this.observations = {};
    return _this;
  }

  (0, _createClass3.default)(NLPView, [{
    key: 'updateObservations',
    value: function updateObservations(observations) {
      ...
      try {
        for (var _iterator = (0, _getIterator3.default)(observations), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var o = _step.value;
    ...
    key: 'saveObservations',
    value: function saveObservations() {
      if (_lodash2.default.isEmpty(this.observations)) {
        return;
      }
      var pairs = this.observations.map(function (item) {
        var val = {
          reported: item.choice_id === 'present'
        };

        if (val.reported) {
          (0, _assign2.default)(val, {
            initial: true
          });
        }
        return [item.id, val];
      });
      var o = _lodash2.default.fromPairs(pairs);
    ...
    value: function destroy() {
      ...
      (0, _get3.default)(NLPView.prototype.__proto__ || (0, _getPrototypeOf2.default)(NLPView.prototype), 'destroy', this).call(this);
    }
  }]);
  return NLPView;
}(_view2.default); /**
...
var _templateObject = (0, _taggedTemplateLiteral3.default)(['\n    <form>\n      <fieldset class="form-group">\n        ', '\n      </fieldset>\n    </form>\n  '], ['\n    <form>\n      <fieldset class="form-group">\n        ', '\n      </fieldset>\n    </form>\n  ']),
    _templateObject2 = (0, _taggedTemplateLiteral3.default)(['              \n            <div class="custom-control custom-radio">\n              <input type="radio" id="', '" name="radio" class="custom-control-input">\n              <label class="custom-control-label" for="', '">', '</label>\n            </div>\n          '], ['              \n            <div class="custom-control custom-radio">\n              <input type="radio" id="', '" name="radio" class="custom-control-input">\n              <label class="custom-control-label" for="', '">', '</label>\n            </div>\n          ']),
...
var answersGroupSingle = function answersGroupSingle(items) {
  return (0, _helpers2.default)(_templateObject, items.map(function (i) {
    return (0, _helpers2.default)(_templateObject2, i.id, i.id, i.name);
  }));
};

var answersGroupMultiple = function answersGroupMultiple(items) {
  return (0, _helpers2.default)(_templateObject, items.map(function (i) {
    return (0, _helpers2.default)(_templateObject3, i.id, i.id, i.name);
  }));
};

var answersSingle = function answersSingle() {
  return (0, _helpers2.default)(_templateObject4);
};
...
var template = function template(context) {
  return new _promise2.default(function (resolve) {
    ...
    resolve((0, _helpers2.default)(_templateObject5, context.question.text, mapper[context.question.type](context.question.items), context.question.type !== 'single' ? '<button class="next-question btn btn-primary">Next question </button>' : ''));
  });
};
...
var QuestionView = function (_View) {
  (0, _inherits3.default)(QuestionView, _View);

  function QuestionView(el, context) {
    var _this;

    (0, _classCallCheck3.default)(this, QuestionView);

    var handleNextQuestion = function handleNextQuestion(e) {
      var group = {};
      if (_this.context.question.type !== 'single') {
        _this.el.querySelectorAll('.custom-control-input').forEach(function (item) {
          group[item.id] = { reported: item.checked };
        });
        _this.context.patient.addSymptomsGroup(group);
        _this.destroy();
        ...
        _this.context.patient.addSymptomsGroup((0, _defineProperty3.default)({}, _this.context.question.items[0].id, { reported: val[e.target.dataset.value] }));
        _this.destroy();
        _this.render();
      }
    };
    ...
    return _this = (0, _possibleConstructorReturn3.default)(this, (QuestionView.__proto__ || (0, _getPrototypeOf2.default)(QuestionView)).call(this, el, _template2.default, context, binds));
  }

  (0, _createClass3.default)(QuestionView, [{
    key: 'render',
    value: function render() {
      var _this2 = this;

      this.el.innerHTML = '<p><i class="fa fa-circle-o-notch fa-spin fa-fw"></i> I am thinking...</p>';
      this.context.api.diagnosis(this.context.patient.toDiagnosis()).then(function (data) {
        _this2.context.question = data.question;
        ...
        if (data['should_stop'] === true) {
          ...
          (0, _get3.default)(QuestionView.prototype.__proto__ || (0, _getPrototypeOf2.default)(QuestionView.prototype), 'render', _this2).call(_this2);
        }
      });
    }
  }]);
...
var _templateObject = (0, _taggedTemplateLiteral3.default)(['\n          <h5 class="card-title">Do you have any of the following symptoms?</h5>\n          <div class="card-text">\n            <form>\n              ', '\n            </form>\n            <p class="text-muted small"><i class="fa fa-info-circle"></i> This is a list of symptoms suggested by our AI, based on the information gathered so far during the interview.</p>\n          </div>\n        '], ['\n          <h5 class="card-title">Do you have any of the following symptoms?</h5>\n          <div class="card-text">\n            <form>\n              ', '\n            </form>\n            <p class="text-muted small"><i class="fa fa-info-circle"></i> This is a list of symptoms suggested by our AI, based on the information gathered so far during the interview.</p>\n          </div>\n        ']),
    _templateObject2 = (0, _taggedTemplateLiteral3.default)(['\n                  <div class="custom-control custom-checkbox">\n                    <input id="', '" type="checkbox" class="input-symptom custom-control-input">\n                    <label for="', '" class="custom-control-label custom-checkbox mb-2 mr-sm-2 mb-sm-0">', '</label>\n                  </div>\n                '], ['\n                  <div class="custom-control custom-checkbox">\n                    <input id="', '" type="checkbox" class="input-symptom custom-control-input">\n                    <label for="', '" class="custom-control-label custom-checkbox mb-2 mr-sm-2 mb-sm-0">', '</label>\n                  </div>\n                ']); /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  * Created by Tomasz Gabrysiak @ Infermedica on 08/02/2017.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  */
...
var template = function template(context) {
  return new _promise2.default(function (resolve) {
    context.api.getSuggestedSymptoms(context.data).then(function (suggestedSymptoms) {
      if (!suggestedSymptoms.length) {
        resolve('<p><i class="fa fa-circle-o-notch fa-spin fa-fw"></i> I am thinking...</p>');
        document.getElementById('next-step').click();
      }
      resolve((0, _helpers2.default)(_templateObject, _lodash2.default.take(suggestedSymptoms, 5).map(function (symptom) {
        return (0, _helpers2.default)(_templateObject2, symptom.id, symptom.id, symptom.name);
      })));
    });
  });
};
...
var SuggestView = function (_View) {
  (0, _inherits3.default)(SuggestView, _View);

  function SuggestView(el, context) {
    var _this;

    (0, _classCallCheck3.default)(this, SuggestView);

    context.data = context.patient.toSuggest();

    var handleSymptomsChange = function handleSymptomsChange(e) {
      var group = {};
      _this.el.querySelectorAll('.input-symptom').forEach(function (item) {
        ...
        if (item.checked) {
          ...
          _this.context.patient.removeSymptom(item.id);
        }
      });
    ...
    return _this = (0, _possibleConstructorReturn3.default)(this, (SuggestView.__proto__ || (0, _getPrototypeOf2.default)(SuggestView)).call(this, el, _template2.default, context, binds));
  }
...
var template = function template(context) {
  return new _promise2.default(function (resolve) {
    context.api.diagnosis(context.patient.toDiagnosis()).then(function (data) {
      resolve((0, _helpers2.default)(_templateObject, data.conditions.map(function (condition) {
        return '\n            <div class="summary-item row">\n              <div class="col-8">\n                ' + condition.name + '\n                ' + (condition.probability >= 0.2 ? '<i class="fa fa-fw fa-eye"></i><a href data-id="' + condition.id + '" class="explain">explain</a>' : '') + '\n              </div>\n              <div class="col-4">\n                <div class="progress">\n                  <div class="progress-bar bg-info" role="progressbar" style="width: ' + Math.floor(condition.probability * 100) + '%">' + Math.floor(condition.probability * 100) + '%</div>\n                </div>\n              </div>\n              <div class="explanation col-12"></div>\n            </div>          \n          ';
      })));
    });
  });
};
...
var SummaryView = function (_View) {
  (0, _inherits3.default)(SummaryView, _View);

  function SummaryView(el, context) {
    (0, _classCallCheck3.default)(this, SummaryView);

    var getExplanationMarkup = function getExplanationMarkup(data) {
      var supporting = '';
      var conflicting = '';
      ...
      try {
        for (var _iterator = (0, _getIterator3.default)(data.supporting_evidence), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var e = _step.value;
      ...
      try {
        for (var _iterator2 = (0, _getIterator3.default)(data.conflicting_evidence), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var _e = _step2.value;

          conflicting += '<li><i class="text-danger fa fa-fw fa-minus-circle"></i> ' + _e.common_name + '</li>';
        }
      } catch (err) {
    ...
    var handleExplainRequested = function handleExplainRequested(e) {
      e.preventDefault();
      var id = e.target.dataset.id;
      var el = e.target.parentNode.parentNode.querySelector('.explanation');

      if (!el.innerHTML) {
        el.innerHTML = '<i class="fa fa-circle-o-notch fa-spin fa-fw"></i> one second..';
        context.api.explain((0, _assign2.default)(context.patient.toDiagnosis(), { target: id })).then(function (data) {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (SummaryView.__proto__ || (0, _getPrototypeOf2.default)(SummaryView)).call(this, el, _template2.default, context, binds));
  }
...
var WelcomeView = function (_View) {
  (0, _inherits3.default)(WelcomeView, _View);

  function WelcomeView(el, context) {
    (0, _classCallCheck3.default)(this, WelcomeView);

    var _this = (0, _possibleConstructorReturn3.default)(this, (WelcomeView.__proto__ || (0, _getPrototypeOf2.default)(WelcomeView)).call(this, el, _template2.default, context, null));

    _this.context.api.generateInterviewId();
    return _this;
  }
...
var DemoController = function (_Controller) {
  (0, _inherits3.default)(DemoController, _Controller);

  function DemoController(el) {
    (0, _classCallCheck3.default)(this, DemoController);

    var _this = (0, _possibleConstructorReturn3.default)(this, (DemoController.__proto__ || (0, _getPrototypeOf2.default)(DemoController)).call(this, el));

    _this.viewMapper = {
      'welcome': _view2.default,
      'basic': _view4.default,
      'suggest': _view6.default,
      'nlp': _view8.default,
      'geo-risks': _view10.default,
      'common-risks': _view12.default,
      'question': _view14.default,
      'summary': _view16.default
    };
    return _this;
  }

  (0, _createClass3.default)(DemoController, [{
    key: '_beforeSetView',
    value: function _beforeSetView(name) {
      var ViewClass = this.viewMapper[name];
      if (ViewClass === _view14.default) {
...
var InfermedicaApi = function () {
  function InfermedicaApi(appId, appKey) {
    var apiModel = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'infermedica-en';
    var apiUrl = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'https://api.infermedica.com/v2/';
    (0, _classCallCheck3.default)(this, InfermedicaApi);
  ...
  (0, _createClass3.default)(InfermedicaApi, [{
    key: 'generateInterviewId',
    value: function generateInterviewId() {
    ...
    key: '_req',
    value: function _req(method, url, data) {
    ...
    key: 'getRiskFactors',
    value: function getRiskFactors() {
      return this._get('risk_factors');
    }
  }, {
    key: 'parse',
    value: function parse(text) {
      return this._post('parse', (0, _stringify2.default)({ 'text': text }));
    }
  }, {
    key: 'getSuggestedSymptoms',
    value: function getSuggestedSymptoms(data) {
      return this._post('suggest', (0, _stringify2.default)(data));
    }
  }, {
    key: 'diagnosis',
    value: function diagnosis(data) {
      return this._post('diagnosis', (0, _stringify2.default)(data));
    }
  }, {
    key: 'explain',
    value: function explain(data) {
      return this._post('explain', (0, _stringify2.default)(data));
    }
  }]);
  return InfermedicaApi;
}();

exports.default = InfermedicaApi;
...
var Patient = function () {
  ...
  (0, _createClass3.default)(Patient, [{
    ...
    key: 'addSymptomsGroup',
    value: function addSymptomsGroup(group) {
      (0, _assign2.default)(this.symptoms, group);
    }
  }, {
    key: 'removeSymptom',
    value: function removeSymptom(id) {
      delete this.symptoms[id];
    }
  }, {
    key: 'toDiagnosis',
    value: function toDiagnosis() {
      var res = {
        sex: this.sex,
        age: this.age,
        evidence: []
      ...
      res.evidence = _lodash2.default.map(this.symptoms, function (symptom, symptomId) {
        var getChoiceId = function getChoiceId(choice) {
          if (choice === true) {
            return 'present';
          }
          if (_lodash2.default.isUndefined(choice)) {
            return 'unknown';
          }
          if (choice === false) {
            return 'absent';
        ...
        var diagnosisSymptom = {
          id: symptomId,
          choice_id: getChoiceId(symptom.reported)
        };

        if (symptom.initial) {
          (0, _assign2.default)(diagnosisSymptom, {
            initial: true
          });
        }
    ...
    key: 'toSuggest',
    value: function toSuggest() {
      var _this = this;

      return {
        sex: this.sex,
        age: this.age,
        selected: _lodash2.default.filter(_lodash2.default.keys(this.symptoms), function (key) {
          return _this.symptoms[key].reported === true;
        })
      };
    }
  }, {
...
var settings = {
  'app-id': '42f5e054',
  'app-key': 'f1e2476dd5e85746f8a8bb89c70cb58e'
};
...
var template = "\n  <div class=\"card\">\n      <div class=\"card-header\">\n          <i class=\"fa fa-user-md\"></i> Symptom Checker <span class=\"d-none d-sm-block float-right text-muted\">powered by <a href=\"http://infermedica.com/\">Gosper AI</a></span>\n      </div>\n      <div id=\"step-container\" class=\"card-block\">\n        <!-- dynamic content goes here -->\n      </div>\n      <div class=\"card-footer\">\n          <button id=\"next-step\" class=\"btn btn-primary float-right\">Next <i class=\"fa fa-chevron-right\"></i></button>\n      </div>\n  </div>\n";
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(22)(Function.call, __webpack_require__(37).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
$export($export.S + $export.F * !__webpack_require__(10), 'Object', { defineProperties: __webpack_require__(62) });
